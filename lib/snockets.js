...
(function() {
  ...
  module.exports = Snockets = (function() {
    ...
    Snockets.prototype.updateDirectives = function(filePath, flags, excludes, callback) {
      var depList, graphChanged, q, require, requireTree,
        _this = this;
      ...
      q = new HoldingQueue({
        task: function(depPath, next) {
          ...
          return _this.updateDirectives(depPath, flags, excludes, function(err, depChanged) {
            if (err) {
              return callback(err);
            }
      ...
      requireTree = function(dirName) {
        ...
        return _this.readdir(_this.absPath(dirName), flags, function(err, items) {
          var item, itemPath, _i, _len, _results;
          if (err) {
            return callback(err);
          }
          q.unwaitFor(dirName);
      ...
      return this.readFile(filePath, flags, function(err, fileChanged) {
        var command, directive, relPath, relPaths, words, _i, _j, _k, _len, _len1, _len2, _ref;
        if (err) {
          return callback(err);
        }
        if (fileChanged) {
